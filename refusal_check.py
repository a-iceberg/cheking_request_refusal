...
class ReasonResponse(BaseModel):
    reasons: Literal[
        "Не было отказа",
        "Выбранную услугу, ремонт уже оказали, оказывают или договорились, что будут оказывать другие: компания, мастера ДРУГОЙ компании, знакомый клиента, САМ клиент и тому подобное - сюда НЕ относятся случи, когда другой человек уже выполнил просто диагностику и клиент отказывается от новых работ или же смена исполнителя произошла из-за недоговоренности по времени или виду работ",
        ...
        "Именно техника САМА заработала, неполадка исправилась, проблема решена, не требует вмешательства. Сюда НЕ относится ремонт кем-то другим, самим клиентом, мастером и т.д.",
        ...
        "Компания изначально не осуществляет возможные запрошенные услуги / ремонт конкретной нужной техники",
        ...
        "Именно клиент и мастер в первую очередь не смогли договориться именно сами друг с другом об удобном времени визита, не важно, будет ли кто-то выполнять работы далее",
