...
class ReasonResponse(BaseModel):
    reasons: Literal[
        ...
        "Клиент посчитал и озвучил, что для него дорого стоят именно сами работы, а не диагностика - ремонт, услуги, их цена большая, в том числе с учётом возможно предложенной скидки - должна обязательно фигурировать конкретная оцененная стоимость работ, а не диагностики, а сама причина быть озвучена до прибытия мастера на адрес, возможно клиент откажется сразу после того, как ему озвучили примерную цену работ",
        "Оказался сложный ремонт, крупногабаритная техника, клиента не будет дома и он не сможет принять мастера или ещё какая-то причина, по которой ремонт осуществляется только в стационарном сервисном центре, не на дому, или клиент хочет сам привезти технику в сервисный центр и спрашивает адрес",
        "Клиент посчитал и озвучил, что для него дорого стоит именно сам выезд мастера по его дальнему адресу, не сами услуги / ремонт, цена выезда большая - должна обязательно фигурировать конкретная оцененная стоимость выезда, а сама причина быть озвучена до прибытия мастера на адрес",
        ...
        "Не успели привезти необходимую технику - подходит, если требовалась установка техники, которую ещё не купили, но интересуются стоимостью",
        ...
        "Клиент и мастер не смогли договориться друг с другом об удобном времени визита, клиента не устраивает сроки прибытия мастера, в этом случае это точно оно - здесь не важно, будет ли кто-то выполнять работы далее",
        "Мастер по той или иной причине не поехал или не позвонил клиенту, хотя должен был в уже обязательно оговоренное время",
