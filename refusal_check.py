...
class ReasonResponse(BaseModel):
    reasons: Literal[
        "Не было отказа",
        "Выбранную услугу, ремонт уже оказали, оказывают или будут оказывать другие в качестве ПЕРВООЧЕРЕДНОЙ причины: компания, мастера другой компании, знакомый клиента, САМ клиент и тому подобное - сюда не относятся случаи, когда другой мастер уже выполнил диагностику и клиент отказывается от работ или же когда смена исполнителя произошла из-за неподходящего времени или вида работ",
        ...
        "Клиент и мастер не смогли договориться друг с другом об удобном времени / дате визита - клиента не устраивают сроки прибытия мастера или мастер не сможет быть к нужному клиенту времени, в этом случае это точно оно - здесь не важно, будет ли кто-то выполнять работы далее",
        ...
        "Клиент говорит, что сам свяжется позже, если понадобится и решит оформить заявку, пока не актуально, или понятно, что мастер в итоге вообще не может дозвониться до клиента, не берут трубку, так как в записях только автоответчик, либо же клиент сам уточнил в разговоре, что не сможет принять мастера, не сможет быть по указанному адресу или, например, заболел и тому подобное",
...
ТОЛЬКО если вы АБСОЛЮТНО уверены, что в диалогах ТОЧНО вообще никоим образом НЕ фигурировал отказ / отмена, или клиент НЕ говорил отбой, отмените заявку и т.д. и другими способами НЕ давал понять, что услуги не нужны, или диалоги в принципе отсутствуют, ТОЛЬКО ТОГДА выбирайте соответствующую причину из представленных - "Не было отказа".
